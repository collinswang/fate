...
//        super.set(Calendar.SECOND, second);
    ...
    public static void main(String[] args) throws Exception {
        ...
        //            // 2012-7-11
        //        }
        mc = new LunarCalendar(2015, 11, 20, 13, 33);
...
//            days = mc.lunarMonthDayCount(i, 10);
//            if (days > 29) {
//                num ++;
//                System.out.println(i + "年10月共有:" + days + "天" );
//            }
//        }
//
//        System.out.println("自" +startYears+"年到" +endYears+"年,10月有30天的共有" + num + "年");
    }
}
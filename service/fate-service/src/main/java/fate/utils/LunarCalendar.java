...
public class LunarCalendar extends GregorianCalendar {
    ...
    */
    ...
    private int       lunarInfo[]       = { 0x4bd8, 0x4ae0, 0xa570, 0x54d5, 0xd260, 0xd950, 0x5554,
            0x56af, 0x9ad0, 0x55d2, 0x4ae0, 0xa5b6, 0xa4d0, 0xd250, 0xd295, 0xb54f, 0xd6a0, 0xada2,
            0x95b0, 0x4977, 0x497f, 0xa4b0, 0xb4b5, 0x6a50, 0x6d40, 0xab54, 0x2b6f, 0x9570, 0x52f2,
            0x4970, 0x6566, 0xd4a0, 0xea50, 0x6a95, 0x5adf, 0x2b60, 0x86e3, 0x92ef, 0xc8d7, 0xc95f,
            0xd4a0, 0xd8a6, 0xb55f, 0x56a0, 0xa5b4, 0x25df, 0x92d0, 0xd2b2, 0xa950, 0xb557, 0x6ca0,
            0xb550, 0x5355, 0x4daf, 0xa5b0, 0x4573, 0x52bf, 0xa9a8, 0xe950, 0x6aa0, 0xaea6, 0xab50,
            0x4b60, 0xaae4, 0xa570, 0x5260, 0xf263, 0xd950, 0x5b57, 0x56a0, 0x96d0, 0x4dd5, 0x4ad0,
            0xa4d0, 0xd4d4, 0xd250, 0xd558, 0xb540, 0xb6a0, 0x95a6, 0x95bf, 0x49b0, 0xa974, 0xa4b0,
            0xb27a, 0x6a50, 0x6d40, 0xaf46, 0xab60, 0x9570, 0x4af5, 0x4970, 0x64b0, 0x74a3, 0xea50,
            0x6b58, 0x5ac0, 0xab60, 0x96d5, 0x92e0, 0xc960, 0xd954, 0xd4a0, 0xda50, 0x7552, 0x56a0,
            0xabb7, 0x25d0, 0x92d0, 0xcab5, 0xa950, 0xb4a0, 0xbaa4, 0xad50, 0x55d9, 0x4ba0, 0xa5b0,
            0x5176, 0x52bf, 0xa930, 0x7954, 0x6aa0, 0xad50, 0x5b52, 0x4b60, 0xa6e6, 0xa4e0, 0xd260,
            0xea65, 0xd530, 0x5aa0, 0x76a3, 0x96d0, 0x4afb, 0x4ad0, 0xa4d0, 0xd0b6, 0xd25f, 0xd520,
            0xdd45, 0xb5a0, 0x56d0, 0x55b2, 0x49b0, 0xa577, 0xa4b0, 0xaa50, 0xb255, 0x6d2f, 0xada0,
            0x4b63, 0x937f, 0x49f8, 0x4970, 0x64b0, 0x68a6, 0xea5f, 0x6b20, 0xa6c4, 0xaaef, 0x92e0,
            0xd2e3, 0xc960, 0xd557, 0xd4a0, 0xda50, 0x5d55, 0x56a0, 0xa6d0, 0x55d4, 0x52d0, 0xa9b8,
            0xa950, 0xb4a0, 0xb6a6, 0xad50, 0x55a0, 0xaba4, 0xa5b0, 0x52b0, 0xb273, 0x6930, 0x7337,
            0x6aa0, 0xad50, 0x4b55, 0x4b6f, 0xa570, 0x54e4, 0xd260, 0xe968, 0xd520, 0xdaa0, 0x6aa6,
    ...
    */
    ...
    /** 当天是否是农历节日 */
    public boolean    isLunarFestival   = false;
    /** 当天是否有节气日 */
    public boolean    isSolarTermInfo   = false;
    /**
     * 当年的生肖
    */
    ...
    */
    ...
    private String    Zhi[]             = { "子", "丑", "寅", "卯", "辰", "巳", "午", "未", "申", "酉", "戌",
            "亥"                        };
    ...
    public LunarCalendar(Birthday birth) {
        super();
        super.clear();
        super.set(Calendar.YEAR, birth.getYear());
        super.set(Calendar.MONTH, birth.getMonth());
        super.set(Calendar.DAY_OF_MONTH, birth.getDay());
        super.set(Calendar.HOUR_OF_DAY, birth.getHour());
        super.set(Calendar.MINUTE, birth.getMinute());
        //        super.set(Calendar.SECOND, second);
        init();
    }
    ...
    public GregorianCalendar getEasterDateByYear(int y) {
        ...
        //求出下個週日
        while (ref.get(Calendar.DAY_OF_WEEK) != Calendar.SUNDAY) {
            ref.add(Calendar.DAY_OF_MONTH, 1);
        }
    ...
    */
    ...
    private int sTerm(int y, int n) {
        int result = 0, index, solarTermBase[] = { 4, 19, 3, 18, 4, 19, 4, 19, 4, 20, 4, 20, 6, 22,
                6, 22, 6, 22, 7, 22, 6, 21, 6, 21 };
        byte temp;
     ...
     * 
     */
    public int lunarMonthDayCount(int y, int m) {
    ...
    private void init() {
        ...
        String solarTerm[] = { "小寒", "大寒", "立春", "雨水", "驚蟄", "春分", "清明", "谷雨", "立夏", "小滿", "芒種",
                "夏至", "小暑", "大暑", "立秋", "處暑", "白露", "秋分", "寒露", "霜降", "立冬", "小雪", "大雪", "冬至" };
        solarTerm[7] += "雨"; //這是big5 編碼問題(即許功蓋問題)所以這樣做
        ...
        if (this.get(Calendar.HOUR_OF_DAY) == 23)
            this.lunarDay++;
        if (this.isLunarLeapMonth)
            this.chineseDateString = "閏" + numToChineseNum(this.lunarMonth) + "月"
    ...
    protected void checkFestival() {
        ...
        //清明節
        if ((solarMonth == 3) && (solarTermDate == solarDay)) {
            lunarFestival = "清明節";
            this.isLunarFestival = true;
            this.isHoliday = true;
        }
    ...
    */
    public static void main(String[] args) throws Exception {
        LunarCalendar mc = new LunarCalendar();
        //        if (args.length == 0) {
        ...
        //            // 2012-7-11
        //        }
        //        mc = new LunarCalendar(2015, 11, 19, 13, 33);
        //
        ...
        //                           + mc.chineseMonthName + "月" + mc.chineseDayName + "日"
        //                           + mc.chineseHourName + "時");
        ...
        //        mc = null;
        //        System.out.println("------------------------------");
        //        Birthday br = new Birthday("2015-11-19"+" "+"13:33:22");
        //        mc = new LunarCalendar(br);
        //
        ...
        for (int i = startYears; i < endYears; i++) {
            days = mc.lunarMonthDayCount(i, month);
            if (days > 29) {
                num++;
                msg += i + "年";
                if (num % 5 == 0) {
        ...
        System.out.println("自" + startYears + "年到" + endYears + "年共有" + (endYears - startYears)
                           + "年");
        System.out.println(month + "月有30天的的年份共有" + num + "年");

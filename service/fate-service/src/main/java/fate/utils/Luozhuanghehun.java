...
public class Luozhuanghehun {
    ...
    public static void main(String[] args) {
        ...
        String manBirth = "1991";
        String womanBirth = "1991";
        Luozhuanghehun my = new Luozhuanghehun();
        String result = my.hehun(manBirth, womanBirth);
        System.out.println(my.getnumber(manBirth, sex.man));
        System.out.println(my.basicsnumber(my.getnumber(manBirth, sex.man), sex.man));

        System.out.println(my.getnumber(womanBirth, sex.woman));
        System.out.println(my.basicsnumber(my.getnumber(womanBirth, sex.woman), sex.woman));
